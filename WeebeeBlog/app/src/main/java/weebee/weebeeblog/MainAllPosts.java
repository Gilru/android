...
public class MainAllPosts extends ListActivity {
    public static final int NUMBER_OF_POSTS = 20;
    public static final String TAG = MainAllPosts.class.getSimpleName();
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        try {
            ...
            Intent intent = new Intent(this,WebViewWebeeActivity.class);
...
//                    our json Data are store in responseData
